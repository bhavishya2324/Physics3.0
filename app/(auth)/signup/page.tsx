      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
          ...
          <div className="max-w-3xl mx-auto text-center pt-12">
            <h1 className="h1">Email us</h1>
            <span className="flex-auto text-center  pl-24 pr-8 -ml-16">abhisheksahu876@gmail.com</span>
          </div> */}
...
<div className='sm:flex sm:justify-center'>
          ...
          <div className="max-w-xs mx-auto sm:max-w-none sm:flex sm:justify-center">
              <div data-aos="fade-up" data-aos-delay="400">
                <a className="btn text-white bg-purple-600 hover:bg-purple-700 w-full mb-4 sm:w-auto sm:mb-0" href="https://www.youtube.com/@Abhisheksahusir">Subscribe Now</a>
              </div>
