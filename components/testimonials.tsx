...
import TestimonialImage01 from '@/public/images/Firefly 20231108205551 (1)-modified.png'
import TestimonialImage02 from '@/public/images/1629794954728.jpg'
import TestimonialImage03 from '@/public/images/393146695_6708430442539713_8679849564022036658_n.jpg'
          ...
          <div className="max-w-sm mx-auto grid gap-8 lg:grid-cols-3 lg:gap-6 items-start lg:max-w-none">
            ...
            <div className="flex flex-col h-full p-6 bg-gray-800" data-aos="fade-up">
              ...
              <div className="text-gray-700 font-medium mt-6 pt-5 border-t border-gray-700">
                <cite className="text-gray-200 not-italic">Bhavishya Sharma</cite> - <a className="text-purple-600 hover:text-gray-200 transition duration-150 ease-in-out" href="https://www.youtube.com/@Abhisheksahusir">Subscribe</a>
              </div>
            </div>
            ...
            <div className="flex flex-col h-full p-6 bg-gray-800" data-aos="fade-up" data-aos-delay="200">
              ...
              <div className="text-gray-700 font-medium mt-6 pt-5 border-t border-gray-700">
                <cite className="text-gray-200 not-italic">Kashish Gupta</cite> - <a className="text-purple-600 hover:text-gray-200 transition duration-150 ease-in-out" href="https://www.youtube.com/@Abhisheksahusir">Subscribe</a>
              </div>
            </div>
            ...
            <div className="flex flex-col h-full p-6 bg-gray-800" data-aos="fade-up" data-aos-delay="400">
              ...
              <div className="text-gray-700 font-medium mt-6 pt-5 border-t border-gray-700">
                <cite className="text-gray-200 not-italic">Lavanya Sharma</cite> - <a className="text-purple-600 hover:text-gray-200 transition duration-150 ease-in-out" href="https://www.youtube.com/@Abhisheksahusir">Subscribe</a>
              </div>
            </div>
